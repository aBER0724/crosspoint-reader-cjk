...
// aBER0724/crosspoint-fonts repository's release-fonts.yml workflow under the
...
#define FONT_MANIFEST_URL                                                                                  \
  "https://github.com/aBER0724/crosspoint-fonts/releases/download/sd-fonts-m" FONT_MANIFEST_URL_STRINGIFY( \
