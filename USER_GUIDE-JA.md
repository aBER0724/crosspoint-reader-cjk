...
- [CrossPoint ユーザーガイド](#crosspoint-ユーザーガイド)
  ...
  - [4. 読書モード](#4-読書モード)
    ...
    - [対応言語](#対応言語)
  - [5. 章選択画面](#5-章選択画面)
  - [6. 現在の制限事項とロードマップ](#6-現在の制限事項とロードマップ)
...
- **Install firmware from SD**：USB を使わず、SD カード上のファームウェアファイルを書き込みます。
  ...
  > 端末が復旧不能になるおそれがあります。
- **Language**：システム言語を設定します。詳しくは**[対応言語](#対応言語)**を参照してください。
...
CrossPoint は次の Unicode 文字ブロックで文字を描画し、幅広い言語に対応します。

* **ラテン文字（基本、補助、拡張 A）：** 英語、ドイツ語、フランス語、スペイン語、ポルトガル語、イタリア語、オランダ語、スウェーデン語、ノルウェー語、デンマーク語、フィンランド語、ポーランド語、チェコ語、ハンガリー語、ルーマニア語、スロバキア語、スロベニア語、トルコ語など。
* **キリル文字（標準および拡張）：** ロシア語、ウクライナ語、ベラルーシ語、ブルガリア語、セルビア語、マケドニア語、カザフ語、キルギス語、モンゴル語など。

非対応：中国語、日本語、韓国語、ベトナム語、ヘブライ語、アラビア語、ギリシャ語、ペルシャ語。
...
このファームウェアは現在も活発に開発されています。以下の機能は**まだ対応していません**が、今後の更新で追加する予定です。

* **画像：** 電子書籍に埋め込まれた画像は描画されません。
* **表紙画像：** EPUB に埋め込まれた大きな表紙画像をスリープ画面やホーム画面のサムネイル用に変換するには数秒かかります（高さ約2000ピクセルで約10秒）。高速化するには、https://github.com/bigbag/epub-to-xtc-converter などで EPUB を最適化してください。
