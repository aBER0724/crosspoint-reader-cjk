...
void HalPowerManager::setPowerSaving(bool enabled) {
  ...
  // CPU frequency changes also change the APB clock used by the shared EPD/SD
  // SPI bus. Serialize the state check and transition so the main and render
  // tasks cannot restore the clock concurrently.
