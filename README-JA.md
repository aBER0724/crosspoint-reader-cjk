...
5. v0.3.3 のまま通常の OTA 更新が使えない場合は、[SD Recovery release](https://github.com/aBER0724/crosspoint-reader-cjk/releases/tag/sd-recovery) を使用してください。`firmware.bin` をダウンロードし、書き込みたい対象ファームウェアと一緒に SD カードのルートに置いて、release ページのファイル名ルールに従ってください。
